 ...
 * @author cesar1
 */
public class ControlArmarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            //Se genera una nueva instancia de ArmariosDAO,ArmariosDTO 
            ArmariosDAO acdao=new ArmariosDAO();
            ArmariosDTO actdto=new ArmariosDTO();
            //se pasan los id's del formulario
            String s = request.getParameter("idARMARIOS");
            actdto.setIdARMARIOS(Integer.parseInt(request.getParameter("idARMARIOS")));

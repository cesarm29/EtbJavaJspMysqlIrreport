 ...
 * @author cesar1
 */
public class ControlBogota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            //Se genera una nueva instancia de BogotaDAO,BogotaDTO
            BogotaDAO acdao=new BogotaDAO();
            BogotaDTO actdto=new BogotaDTO();
            //se pasan los id's del formulario
            String s = request.getParameter("idBOGOTA");
            actdto.setIdBOGOTA(Integer.parseInt(request.getParameter("idBOGOTA")));

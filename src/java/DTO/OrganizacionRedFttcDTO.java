 ...
 * @author cesar1
 */
public class OrganizacionRedFttcDTO {
//se definen los datos    
private int idORGANIZACIONREDFTTC=0;  
...
public OrganizacionRedFttcDTO(int idORGANIZACIONREDFTTC, String central, int distrito, int pr, String tema, int costocontrato, int costoproyecto, int pares, String estado, String fechaentrega, String inicioprogramado, String finprogramado, String avance, String fechareporte, String mesfacturacion, String contratista, int USUARIOS_idUSUARIOS) {
    ...
    /**
     * @return the idORGANIZACIONREDFTTC
     */
    public int getIdORGANIZACIONREDFTTC() {
        return idORGANIZACIONREDFTTC;
    }

    /**
     * @param idORGANIZACIONREDFTTC the idORGANIZACIONREDFTTC to set
     */
    public void setIdORGANIZACIONREDFTTC(int idORGANIZACIONREDFTTC) {
        this.idORGANIZACIONREDFTTC = idORGANIZACIONREDFTTC;
    }

 ...
 * @author cesar1
 */
public class RegionalesBaseDTO {
//se definen los datos
private int idREGIONALESBASE=0;
...
private int USUARIOS_idUSUARIOS=0;
    ...
    /**
     * @return the idREGIONALESBASE
     */
    public int getIdREGIONALESBASE() {
        return idREGIONALESBASE;
    }

    /**
     * @param idREGIONALESBASE the idREGIONALESBASE to set
     */
    public void setIdREGIONALESBASE(int idREGIONALESBASE) {
        this.idREGIONALESBASE = idREGIONALESBASE;
    }

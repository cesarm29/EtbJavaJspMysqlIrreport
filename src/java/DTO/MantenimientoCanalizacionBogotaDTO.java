 ...
 * @author cesar1
 */
public class MantenimientoCanalizacionBogotaDTO {
//se definen los datos    
private int idMANTENIMIENTOCANALIZACIONBOGOTA=0;
...
private int USUARIOS_idUSUARIOS=0;
    ...
    /**
     * @return the idMANTENIMIENTOCANALIZACIONBOGOTA
     */
    public int getIdMANTENIMIENTOCANALIZACIONBOGOTA() {
        return idMANTENIMIENTOCANALIZACIONBOGOTA;
    }

    /**
     * @param idMANTENIMIENTOCANALIZACIONBOGOTA the idMANTENIMIENTOCANALIZACIONBOGOTA to set
     */
    public void setIdMANTENIMIENTOCANALIZACIONBOGOTA(int idMANTENIMIENTOCANALIZACIONBOGOTA) {
        this.idMANTENIMIENTOCANALIZACIONBOGOTA = idMANTENIMIENTOCANALIZACIONBOGOTA;
    }

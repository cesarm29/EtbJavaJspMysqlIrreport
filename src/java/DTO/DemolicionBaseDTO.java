 ...
 * @author cesar1
 */
public class DemolicionBaseDTO {
    //se definen los datos
    private int idDEMOLICIONBASE=0;
    ...
    //get y set datos
    /**
     * @return the idDEMOLICIONBASE
     */
    public int getIdDEMOLICIONBASE() {
        return idDEMOLICIONBASE;
    }

    /**
     * @param idDEMOLICIONBASE the idDEMOLICIONBASE to set
     */
    public void setIdDEMOLICIONBASE(int idDEMOLICIONBASE) {
        this.idDEMOLICIONBASE = idDEMOLICIONBASE;
    }

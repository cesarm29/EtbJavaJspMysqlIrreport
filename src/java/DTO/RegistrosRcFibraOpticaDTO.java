 ...
 * @author cesar1
 */
public class RegistrosRcFibraOpticaDTO {
// se definen los datos    
private int idREGISTROSRCFIBRAOPTICA=0;
...
private int USUARIOS_idUSUARIOS=0;
    ...
    /**
     * @return the idREGISTROSRCFIBRAOPTICA
     */
    public int getIdREGISTROSRCFIBRAOPTICA() {
        return idREGISTROSRCFIBRAOPTICA;
    }

    /**
     * @param idREGISTROSRCFIBRAOPTICA the idREGISTROSRCFIBRAOPTICA to set
     */
    public void setIdREGISTROSRCFIBRAOPTICA(int idREGISTROSRCFIBRAOPTICA) {
        this.idREGISTROSRCFIBRAOPTICA = idREGISTROSRCFIBRAOPTICA;
    }

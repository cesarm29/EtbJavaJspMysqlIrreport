 ...
 * @author cesar1
 */
public class AcometidasElectricasDTO {
    
    //se definen el tipo de dato 
    private int idACOMETIDASELECTRICAS=0;
    ...
    /**
     * @return the idACOMETIDASELECTRICAS
     */
    public int getIdACOMETIDASELECTRICAS() {
        return idACOMETIDASELECTRICAS;
    }

    /**
     * @param idACOMETIDASELECTRICAS the idACOMETIDASELECTRICAS to set
     */
    public void setIdACOMETIDASELECTRICAS(int idACOMETIDASELECTRICAS) {
        this.idACOMETIDASELECTRICAS = idACOMETIDASELECTRICAS;
    }

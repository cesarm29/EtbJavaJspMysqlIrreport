 ...
 * @author cesar1
 */
public class OrganizacionRedDTO {
    //se definen los datos
    private int idORGANIZACIONRED=0;
    ...
    // get y set datos
    /**
     * @return the idORGANIZACIONRED
     */
    public int getIdORGANIZACIONRED() {
        return idORGANIZACIONRED;
    }

    /**
     * @param idORGANIZACIONRED the idORGANIZACIONRED to set
     */
    public void setIdORGANIZACIONRED(int idORGANIZACIONRED) {
        this.idORGANIZACIONRED = idORGANIZACIONRED;
    }

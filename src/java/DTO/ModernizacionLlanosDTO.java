 ...
 * @author cesar1
 */
public class ModernizacionLlanosDTO {
    //se definen los datos
    private int idMODERNIZACIONLLANOS=0;
    ...
    /**
     * @return the idMODERNIZACIONLLANOS
     */
    public int getIdMODERNIZACIONLLANOS() {
        return idMODERNIZACIONLLANOS;
    }

    /**
     * @param idMODERNIZACIONLLANOS the idMODERNIZACIONLLANOS to set
     */
    public void setIdMODERNIZACIONLLANOS(int idMODERNIZACIONLLANOS) {
        this.idMODERNIZACIONLLANOS = idMODERNIZACIONLLANOS;
    }

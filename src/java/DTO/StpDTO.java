...
public class StpDTO {
    ...
    /**
     * @param idSTP the idSTP to set
     */
    public void setIdSTP(int idSTP) {
        this.idSTP = idSTP;
    }

 ...
 * @author cesar1
 */
public class PosteriaDTO {
//se definen datos    
private int idPOSTERIA=0;
...
private int USUARIOS_idUSUARIOS=0;
    ...
    //get y set datos
    /**
     * @return the idPOSTERIA
     */
    public int getIdPOSTERIA() {
        return idPOSTERIA;
    }

    /**
     * @param idPOSTERIA the idPOSTERIA to set
     */
    public void setIdPOSTERIA(int idPOSTERIA) {
        this.idPOSTERIA = idPOSTERIA;
    }

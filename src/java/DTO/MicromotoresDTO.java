 ...
 * @author cesar1
 */
public class MicromotoresDTO {
//se definen los datos    
private int idMICROMOTORES=0;
...
private int USUARIOS_idUSUARIOS=0;
    ...
    /**
     * @return the idMICROMOTORES
     */
    public int getIdMICROMOTORES() {
        return idMICROMOTORES;
    }

    /**
     * @param idMICROMOTORES the idMICROMOTORES to set
     */
    public void setIdMICROMOTORES(int idMICROMOTORES) {
        this.idMICROMOTORES = idMICROMOTORES;
    }

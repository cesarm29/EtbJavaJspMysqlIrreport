 ...
 * @author cesar1
 */
public class BaseDeArmarioDTO {
    //se define el tipo de dato
    private int idBASEDEARMARIO=0;
    ...
    //get y set de datos
    /**
     * @return the idBASEDEARMARIO
     */
    public int getIdBASEDEARMARIO() {
        return idBASEDEARMARIO;
    }

    /**
     * @param idBASEDEARMARIO the idBASEDEARMARIO to set
     */
    public void setIdBASEDEARMARIO(int idBASEDEARMARIO) {
        this.idBASEDEARMARIO = idBASEDEARMARIO;
    }

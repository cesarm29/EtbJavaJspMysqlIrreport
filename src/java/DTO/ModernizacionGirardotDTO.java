 ...
 * @author cesar1
 */
public class ModernizacionGirardotDTO {
    //se definen los datos
    private int idMODERNIZACIONGIRARDOT=0;
    ...
    //get y set datos
    /**
     * @return the idMODERNIZACIONGIRARDOT
     */
    public int getIdMODERNIZACIONGIRARDOT() {
        return idMODERNIZACIONGIRARDOT;
    }

    /**
     * @param idMODERNIZACIONGIRARDOT the idMODERNIZACIONGIRARDOT to set
     */
    public void setIdMODERNIZACIONGIRARDOT(int idMODERNIZACIONGIRARDOT) {
        this.idMODERNIZACIONGIRARDOT = idMODERNIZACIONGIRARDOT;
    }

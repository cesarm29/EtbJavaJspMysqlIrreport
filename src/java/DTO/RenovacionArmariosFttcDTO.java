 ...
 * @author cesar1
 */
public class RenovacionArmariosFttcDTO {
//se definen los datos
private int idRENOVACIONARMARIOSFTTC=0;
...
private int USUARIOS_idUSUARIOS=0;
    ...
    public RenovacionArmariosFttcDTO(int idRENOVACIONARMARIOSFTTC, String central, int distrito, int pr, String tema, int costocontrato, int costoproyecto, int pares, String estado, String fechaentrega, String inicioprogramado, String finprogramado, String avance, String fechareporte, String mesfacturacion, String contratista, int USUARIOS_idUSUARIOS) {
        ...
        //get y set datos
    /**
     * @return the idRENOVACIONARMARIOSFTTC
     */
    public int getIdRENOVACIONARMARIOSFTTC() {
        return idRENOVACIONARMARIOSFTTC;
    }

    /**
     * @param idRENOVACIONARMARIOSFTTC the idRENOVACIONARMARIOSFTTC to set
     */
    public void setIdRENOVACIONARMARIOSFTTC(int idRENOVACIONARMARIOSFTTC) {
        this.idRENOVACIONARMARIOSFTTC = idRENOVACIONARMARIOSFTTC;
    }

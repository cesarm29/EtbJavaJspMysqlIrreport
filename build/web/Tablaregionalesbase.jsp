<%-- 
    Document   : Tablaregionalesbase
    Created on : 16/07/2014, 11:18:07 AM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearregionalesbase.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Regionales Base</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Regionales Base</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
        ...
        <div class="container">		
			...
			<right><input type="text" id="q" name="q" value="" placeholder="Busqueda por pr"/></right>
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de RegionalesBaseDAO
                            RegionalesBaseDAO obj2 = new RegionalesBaseDAO();
                            ...
                            if(request.getParameter("page") != null && request.getParameter("page") !=""){
                                //se asigna a la variable pageNro el paramatro page
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablaregionalesbase.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formularioregionalesbase.jsp?ID=" + resul.getString("idREGIONALESBASE") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formularioregionalesbase.jsp?ID=" + resul.getString("idREGIONALESBASE") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

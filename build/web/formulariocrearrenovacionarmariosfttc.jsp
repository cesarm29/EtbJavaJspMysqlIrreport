<%-- 
    Document   : formulariocrearrenovacionarmariosfttc
    Created on : 11/08/2014, 02:29:02 PM
    Author     : cesar
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de RenovacionArmariosFttcDTO
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlCrearRenovacionArmariosFttc" method="post">

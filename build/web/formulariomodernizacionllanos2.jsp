<%-- 
    Document   : newjsformulariomodernizacionllanos2
    Created on : 15/07/2014, 10:13:38 AM
    Author     : cesar1
--%>

<%@page import="DAO.ModernizacionLlanos2DAO"%>
<%@page import="DTO.ModernizacionLlanos2DTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de ModernizacionLlanos2DTO
                ModernizacionLlanos2DTO a = new ModernizacionLlanos2DTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de ModernizacionLlanos2DAO
                    ModernizacionLlanos2DAO d = new ModernizacionLlanos2DAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Renovacion Red Llanos Fase 2</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Renovacion Red Llanos Fase 2</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlModernizacionLlanos2" method="post">
                            ...
                            <input type="number" name="idMODERNIZACIONLLANOS2" value="<%= a.getIdMODERNIZACIONLLANOS2()%>" id="idMODERNIZACIONLLANOS2" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablamodernizacionllanos2.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

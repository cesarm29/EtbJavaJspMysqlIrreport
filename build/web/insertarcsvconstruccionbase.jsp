<%-- 
    Document   : insertarcsvconstruccionbase
    Created on : 28/08/2014, 09:48:20 AM
    Author     : cesar
--%>
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    if(count > 0){
                        ...
                        String sql ="insert into construccionbase (idCONSTRUCCIONBASE, central, distrito, pr, tema, costocontrato, costoproyecto, pares, estado, fechaentrega, inicioprogramado, finprogramado, avance, fechareporte, mesfacturacion, contratista, USUARIOS_idUSUARIOS) values(";

<%-- 
    Document   : formulariocrearposteria
    Created on : 11/08/2014, 11:30:36 AM
    Author     : cesar
--%>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instanciacion de PosteriaDAO
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlCrearPosteria" method="post">

<%-- 
    Document   : formularioposteria
    Created on : 17/07/2014, 02:40:36 PM
    Author     : cesar1
--%>

<%@page import="DTO.PosteriaDTO"%>
<%@page import="DAO.PosteriaDAO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de PosteriaDTO
                PosteriaDTO a = new PosteriaDTO();
                //se crean dos string's y van a ser igual a 2 parametros Accion y ID que se reciben por un request
                String accion = request.getParameter("Accion");
                String id = request.getParameter("ID");
                //evalua si la accion es igual a Eliminar o Editar o Vacio, si es igual a Editar les asigna a ña variable
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de PosteriaDAO
                    PosteriaDAO d = new PosteriaDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Posteria</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario Posteria</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlPosteria" method="post">
                            ...
                            <input type="number" name="idPOSTERIA" value="<%= a.getIdPOSTERIA()%>" id="idPOSTERIA" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaposteria.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

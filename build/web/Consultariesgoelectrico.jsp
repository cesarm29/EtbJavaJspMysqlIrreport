<%-- 
    Document   : Consultariesgoelectrico
    Created on : 21/07/2014, 02:04:24 PM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
    <head>
        ...
        <script type="text/javascript">
            <%
                //RiesgoElectricoDTO se le da el valor de null
                RiesgoElectricoDTO contrado = null;
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Consulta Riesgo Electrico</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Consulta Riesgo Electrico</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">                    
                    ...
                    <center><header>Riesgo Electrico</header></center>                         
                    <fieldset>
                    ...
                    <div style="width: 70%; margin: 0px auto;">         
                        <% if (contrado != null) {
                                ...
                                if (id != null)//ejecuta
                                {
                                    out.print("<center><div style=\"color: red\">El Registro de Riesgo Electrico No Existe</div></center>");
                                }
                            }
                        %>
                    </div>

<%-- 
    Document   : formulariocrearmodernizacionllanos2
    Created on : 11/08/2014, 11:04:11 AM
    Author     : cesar
--%>
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlCrearModernizacionLlanos2" method="post">

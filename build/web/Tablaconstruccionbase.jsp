<%-- 
    Document   : Tablaconstruccionbase
    Created on : 26/06/2014, 01:19:02 PM
    Author     : cesar1
--%>

<%@page import="java.sql.ResultSet"%>
<%@page import="DAO.ConstruccionBaseDAO"%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearconstruccionbase.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Construccion Base</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Construccion Base</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de ConstruccionBaseDAO
                            ConstruccionBaseDAO obj2 = new ConstruccionBaseDAO();
                            //se recibe parametro q y se asigna a la variable filtro
                            String filtro = request.getParameter("q");
                            if (filtro == null)filtro = "";
                            int pageNro= 1;
                            //se recibe parametro page cuando sea diferente de null y diferente a vacio
                            if(request.getParameter("page") != null && request.getParameter("page") !=""){
                                //se asigna a la variable pageNro el parametro page
                                pageNro = Integer.parseInt(request.getParameter("page"));
                            }
                            //se reciben los dato de un resulset pasandole los parametros filtro, pageNro
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablaconstruccionbase.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formularioconstruccionbase.jsp?ID=" + resul.getString("idCONSTRUCCIONBASE") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formularioconstruccionbase.jsp?ID=" + resul.getString("idCONSTRUCCIONBASE") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

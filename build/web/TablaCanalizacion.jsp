<%-- 
    Document   : TablaCanalizacion
    Created on : 26/06/2014, 02:11:11 PM
    Author     : cesar1
--%>

<%@page import="java.sql.ResultSet"%>
<%@page import="DAO.CanalizacionDAO"%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearcanalizacion.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Mantenimiento Canalizacion Regionales</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Mantenimiento Canalizacion Regionales</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de Canalizacion
                            CanalizacionDAO obj2 = new CanalizacionDAO();
                            ...
                            //se asignan a las variables y se verifica el total de los registros, por ultimo se divide el total por la cantidad de filas que se quiere mostrar
                            int total = obj2.getTotalRegistro(filtro != "");
                            int totalPag = (total / 10);
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="TablaCanalizacion.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <% 
                                        try {
                                            ...
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formulariocanalizacion.jsp?ID=" + resul.getString("idCANALIZACION") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formulariocanalizacion.jsp?ID=" + resul.getString("idCANALIZACION") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

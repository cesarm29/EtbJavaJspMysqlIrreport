<%-- 
    Document   : Tablariesgoelectrico
    Created on : 21/07/2014, 08:20:28 AM
    Author     : cesar1
--%>

<%@page import="java.sql.ResultSet"%>
<%@page import="DAO.RiesgoElectricoDAO"%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
            ...
            */
            ...
            (min-device-width: 768px) and (max-device-width: 1024px)  {
                ...
                */
                ...
                td:nth-of-type(9):before { content: "Inicio Programado"; }
                td:nth-of-type(10):before { content: "Fin Programado"; }
                td:nth-of-type(11):before { content: "Avance"; }
                td:nth-of-type(12):before { content: "Fecha Reporte"; }
                td:nth-of-type(13):before { content: "Mes Facturacion"; }
                td:nth-of-type(14):before { content: "Contratista"; }
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearriesgoelectrico.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Riesgo Electrico</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Riesgo Electrico</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
        ...
        <div class="container">		
			...
			<right><input type="text" id="q" name="q" value="" placeholder="Busqueda por pr"/></right>
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de RiesgoElectricoDAO
                            RiesgoElectricoDAO obj2 = new RiesgoElectricoDAO();
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablariesgoelectrico.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formularioriesgoelectrico.jsp?ID=" + resul.getString("idRIESGOELECTRICO") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formularioriesgoelectrico.jsp?ID=" + resul.getString("idRIESGOELECTRICO") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

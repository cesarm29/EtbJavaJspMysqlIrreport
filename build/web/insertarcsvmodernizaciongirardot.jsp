<%-- 
    Document   : insertarcsvmodernizaciongirardot
    Created on : 28/08/2014, 11:00:53 AM
    Author     : cesar
--%>
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    if(count > 0){
                        ...
                        String sql ="insert into modernizaciongirardot (idMODERNIZACIONGIRARDOT, central, distrito, pr, tema, costocontrato, costoproyecto, pares, estado, fechaentrega, inicioprogramado, finprogramado, avance, fechareporte, mesfacturacion, contratista, USUARIOS_idUSUARIOS) values(";

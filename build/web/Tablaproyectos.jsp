<%-- 
    ...
    Created on : 1/07/2014, 10:17:00 AM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearproyecto.jsp?ID=0&Accion=';
                });
    ...
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Construccion con Demolicion</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Construccion con Demolicion</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        ...
                        <p>Paginas
                            ...
                            ProyectoDAO obj2 = new ProyectoDAO();
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablaproyectos.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formularioproyecto.jsp?ID=" + resul.getString("idPROYECTOS") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formularioproyecto.jsp?ID=" + resul.getString("idPROYECTOS") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

<%-- 
    Document   : formularioorganizacionred
    Created on : 24/06/2014, 09:02:30 AM
    Author     : cesar1
--%>

<%@page import="DAO.OrganizacionRedDAO"%>
<%@page import="DTO.OrganizacionRedDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%
                ...
                String Title = "Crear";
                //se crea una nueva instancia de OrganizacionRedDTO
                OrganizacionRedDTO a = new OrganizacionRedDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de OrganizacionRedDAO
                    OrganizacionRedDAO d = new OrganizacionRedDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Organizacion Red</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Organizacion Red</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlOrganizacionRed" method="post">
                            ...
                            <input type="number" name="idORGANIZACIONRED" value="<%= a.getIdORGANIZACIONRED()%>" id="idORGANIZACIONRED" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaorganizacionred.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

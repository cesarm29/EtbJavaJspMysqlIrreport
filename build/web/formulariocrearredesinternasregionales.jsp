<%-- 
    Document   : formulariocrearredesinternasregionales
    Created on : 11/08/2014, 01:11:20 PM
    Author     : cesar
--%>
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlCrearRedesInternasRegionales" method="post">

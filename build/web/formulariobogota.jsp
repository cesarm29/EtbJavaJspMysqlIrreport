<%-- 
    Document   : formulariobogota
    Created on : 16/07/2014, 02:58:10 PM
    Author     : cesar1
--%>

<%@page import="DAO.BogotaDAO"%>
<%@page import="DTO.BogotaDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de BogotaDTO
                BogotaDTO a = new BogotaDTO();
                //se crean dos string's y van a ser igual a 2 parametros Accion y ID que se reciben por un request
                String accion = request.getParameter("Accion");
                String id = request.getParameter("ID");
                //evalua si la accion es igual a Eliminar o Editar o Vacion, si es igual a Editar les asigna a la variable
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de BogotaDAO
                    BogotaDAO d = new BogotaDAO();
                    try {//trae los datos por id a el formulario
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Bogota</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario Bogota</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlBogota" method="post">
                            ...
                            <input type="number" name="idBOGOTA" value="<%= a.getIdBOGOTA()%>" id="idBOGOTA" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablabogota.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

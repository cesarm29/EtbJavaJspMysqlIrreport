<%-- 
    Document   : formularioregionales
    Created on : 15/07/2014, 02:01:15 PM
    Author     : cesar1
--%>

<%@page import="DAO.RegionalesDAO"%>
<%@page import="DTO.RegionalesDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de RegionalesDTO
                RegionalesDTO a = new RegionalesDTO();
                //se crean dos string's y van a ser igual a 2 parametros Accion y ID que se reciben por un request
                String accion = request.getParameter("Accion");
                String id = request.getParameter("ID");
                //evalua si la accion se igual a Eliminar o Editar o Vacio, si es igual a Editar les asigna a la variable
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de RegionalesDAO
                    RegionalesDAO d = new RegionalesDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario de Regionales</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario de Regionales</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlRegionales" method="post">
                            ...
                            <input type="number" name="idREGIONALES" value="<%= a.getIdREGIONALES()%>" id="idREGIONALES" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaregionales.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

<%-- 
    Document   : formulariocrearproyecto
    Created on : 11/08/2014, 11:47:54 AM
    Author     : cesar
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%      //se crea string y se le asigna un titulo
                    ...
                    //evalua si la accion es igual a Eliminar o Editar o Vacio, si e sigual a Editar las asigna a la variable 
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Construccion con Demolicion</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Construccion con Demolicion</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlCrearProyecto" method="post">
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaproyectos.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

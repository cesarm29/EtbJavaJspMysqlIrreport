<%-- 
    Document   : formulariobasedearmario
    Created on : 24/06/2014, 09:36:23 AM
    Author     : cesar1
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de BaseDeArmarioDTO
                BaseDeArmarioDTO a = new BaseDeArmarioDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de BaseArmarioDAO
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Base de Armario</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario Base de Armario</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlBaseArmario" method="post">
                            ...
                            <input type="number" name="idBASEDEARMARIO" value="<%= a.getIdBASEDEARMARIO()%>" id="idBASEDEARMARIO" /> 
                            <label>Central :</label>

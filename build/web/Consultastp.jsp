<%-- 
    Document   : Consultastp
    Created on : 2/07/2014, 10:01:37 AM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
    <head>
        ...
        <script type="text/javascript">
            <%
                //StpDTO se le da el valor de null
                StpDTO contrado = null;
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Consulta SPT</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Consulta SPT</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><header>SPT</header></center>                        
                    <fieldset>
                    ...
                    <div style="width: 70%; margin: 0px auto;">         
                        <% if (contrado != null) {
                                ...
                                if (id != null)//ejecuta
                                {
                                    out.print("<center><div style=\"color: red\">El SPT No Existe</div></center>");
                                }
                            }
                        %>
                    </div>

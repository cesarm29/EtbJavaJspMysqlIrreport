<%-- 
    Document   : Tablamodernizaciongirardot
    Created on : 26/06/2014, 10:20:41 AM
    Author     : cesar1
--%>

<%@page import="java.sql.ResultSet"%>
<%@page import="DAO.ModernizacionGirardotDAO"%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearmodernizaciongirardot.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Renovacion Red Girardot</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Renovacion Red Girardot</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de ModernizacionGirardotDAO
                            ModernizacionGirardotDAO obj2 = new ModernizacionGirardotDAO();
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formulariomodernizaciongirardot.jsp?ID=" + resul.getString("idMODERNIZACIONGIRARDOT") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formulariomodernizaciongirardot.jsp?ID=" + resul.getString("idMODERNIZACIONGIRARDOT") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

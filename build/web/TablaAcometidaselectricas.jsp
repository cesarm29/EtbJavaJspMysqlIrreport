<%-- 
    Document   : TablaAcometidaselectricas
    Created on : 27/06/2014, 03:20:29 PM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearacometidaselectricas.jsp?ID=0&Accion=';
                });
            });
        </script> 
    ...
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Acometidas Electricas</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Acometidas Electricas</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de AcometidasElectricas
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="TablaAcometidaselectricas.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                        ...
                        <table>
                                    ...
                                    <%
                                        try {
                                            ...
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formularioacometidaselectricas.jsp?ID=" + resul.getString("idACOMETIDASELECTRICAS") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formularioacometidaselectricas.jsp?ID=" + resul.getString("idACOMETIDASELECTRICAS") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {
                            ...
                            <% out.print(request.getParameter("msg")!=null ? "<h1>"+request.getParameter("msg")+"</h1>":""); %>

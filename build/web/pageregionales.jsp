<%-- 
    Document   : pageregionales
    Created on : 28/08/2014, 03:00:01 PM
    Author     : cesar
--%>
    ...
    <head>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Subir Archivo CSV de Regionales</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active">Subir Archivo CSV de Regionales</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">                    
                    ...
                    <center>
                        <form ENCTYPE="multipart/form-data" ACTION="insertarcsvregionales.jsp" METHOD=POST class="reg-page">

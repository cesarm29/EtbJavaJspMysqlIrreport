<%-- 
    Document   : ReporteDemolicionBase
    Created on : 10/07/2014, 01:13:54 PM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Demolicion Base</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report8.jasper"));

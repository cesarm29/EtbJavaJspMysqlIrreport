<%-- 
    Document   : ReporteConstruccionConDemolicion
    Created on : 28/07/2014, 09:26:10 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Construccion con Demolicion</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report17.jasper"));

<%-- 
    Document   : ReporteCanalizacion
    Created on : 10/07/2014, 10:01:27 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Canalizacion</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report6.jasper"));

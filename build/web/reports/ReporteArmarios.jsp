<%-- 
    Document   : ReporteArmarios
    Created on : 23/07/2014, 11:42:43 AM
    Author     : cesar1
--%>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report3.jasper"));

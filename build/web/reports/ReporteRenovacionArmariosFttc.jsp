<%-- 
    Document   : ReporteRenovacionArmariosFttc
    Created on : 29/07/2014, 10:38:02 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Renovacion Armarios</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report22.jasper"));

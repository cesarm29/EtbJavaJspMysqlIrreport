<%-- 
    Document   : ReporteModernizacionLlanos
    Created on : 11/07/2014, 10:24:03 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Modernizacion LLanos Fase 1</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report12.jasper"));

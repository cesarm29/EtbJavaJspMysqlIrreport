<%-- 
    Document   : ReporteRegionalesBase
    Created on : 29/07/2014, 07:55:12 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Regionales Base</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report20.jasper"));

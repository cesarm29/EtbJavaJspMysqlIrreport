<%-- 
    Document   : ReporteModernizacionLlanos2
    Created on : 25/07/2014, 11:48:37 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Modernizacion LLanos Fase 2</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report13.jasper"));

<%-- 
    Document   : formularioarmario
    Created on : 15/07/2014, 11:36:41 AM
    Author     : cesar1
--%>

<%@page import="DAO.ArmariosDAO"%>
<%@page import="DTO.ArmariosDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de ArmariosDTO
                ArmariosDTO a = new ArmariosDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de ArmariosDAO
                    ArmariosDAO d = new ArmariosDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario de armario</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario de Armario</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlArmarios" method="post">
                            ...
                            <input type="number" name="idARMARIOS" value="<%= a.getIdARMARIOS()%>" id="idARMARIOS" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaarmario.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>

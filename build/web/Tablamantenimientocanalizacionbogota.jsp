<%-- 
    Document   : Tablamantenimientocanalizacionbogota
    Created on : 17/07/2014, 09:09:24 AM
    Author     : cesar1
--%>

<%@page import="java.sql.ResultSet"%>
<%@page import="DAO.MantenimientoCanalizacionBogotaDAO"%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearmantenimientocanalizacionbogota.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Mantenimiento Canalizacion Bogota</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Mantenimiento Canalizacion Bogota</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
        ...
        <div class="container">		
			...
			<right><input type="text" id="q" name="q" value="" placeholder="Busqueda por pr"/></right>
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de MantenimientoCanalizacionBogotaDAO
                             MantenimientoCanalizacionBogotaDAO obj2 = new MantenimientoCanalizacionBogotaDAO();
                            ...
                            //se asignan a las variables y se verifica el total de registros, por ultimo se divide el total por la cantidad de filas que se quiere mostrar
                            int total = obj2.getTotalRegistro(filtro != "");
                            int totalPag = (total / 10);
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablamantenimientocanalizacionbogota.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formulariomantenimientocanalizacionbogota.jsp?ID=" + resul.getString("idMANTENIMIENTOCANALIZACIONBOGOTA") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formulariomantenimientocanalizacionbogota.jsp?ID=" + resul.getString("idMANTENIMIENTOCANALIZACIONBOGOTA") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

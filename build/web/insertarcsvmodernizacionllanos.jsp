<%-- 
    Document   : insertarcsvmodernizacionllanos
    Created on : 28/08/2014, 11:22:04 AM
    Author     : cesar
--%>
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    if(count > 0){
                        ...
                        String sql ="insert into modernizacionllanos (idMODERNIZACIONLLANOS, central, distrito, pr, tema, costocontrato, costoproyecto, pares, estado, fechaentrega, inicioprogramado, finprogramado, avance, fechareporte, mesfacturacion, contratista, USUARIOS_idUSUARIOS) values(";

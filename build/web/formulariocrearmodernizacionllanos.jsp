<%-- 
    Document   : formulariocrearmodernizacionllanos
    Created on : 11/08/2014, 10:53:44 AM
    Author     : cesar
--%>
        ...
        <script type="text/javascript">
            <%
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de ModernizacionLlanosDAO
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlCrearModernizacionLlanos" method="post">

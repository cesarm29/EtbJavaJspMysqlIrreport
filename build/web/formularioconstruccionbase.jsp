<%-- 
    Document   : formularioconstruccionbase
    Created on : 24/06/2014, 09:26:52 AM
    Author     : cesar1
--%>


<%@page import="DTO.ConstruccionBaseDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de ConstruccionBaseDTO
                ConstruccionBaseDTO a = new ConstruccionBaseDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de ConstruccionBaseDAO
                    ConstruccionBaseDAO d = new ConstruccionBaseDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Construccion Base</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Construccion Base</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlConstruccionBase" method="post">
                            ...
                            <input type="number" name="idCONSTRUCCIONBASE" value="<%= a.getIdCONSTRUCCIONBASE()%>" id="idCONSTRUCCIONBASE" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaconstruccionbase.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

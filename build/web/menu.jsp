<%-- 
    Document   : menu
    Created on : 3/07/2014, 11:45:19 AM
    Author     : cesar1
--%>
    ...
    <body>
        ...
        <div class="header">               
            <div class="container"> 
                ...
                <h3><IMG SRC="img/user.png"> Bienvenido Usuario: <%=(String) session.getAttribute("nombreUsuario")%></h3>
                <!-- Menu -->       
                <div class="navbar">                                
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Menu</h1>
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">                    
                    ...
                    <center><img src="assets/images/header1.png" alt="Imagen del logotipo" style="max-width: 100%;" /></center>
                    </br>
                    </br>
                    </br>
                    </br>

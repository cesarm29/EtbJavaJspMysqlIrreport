<%-- 
    Document   : Tablamodernizacionllanos
    Created on : 26/06/2014, 08:57:35 AM
    Author     : cesar1
--%>

<%@page import="DAO.ModernizacionLlanosDAO"%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearmodernizacionllanos.jsp?ID=0&Accion=';
                });
    ...
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Renovacion Red Llanos Fase 1</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Renovacion Red Llanos Fase 1</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de ModernizacionLlanosDAO
                            ModernizacionLlanosDAO obj2 = new ModernizacionLlanosDAO();
                            //se recibe paramatro q y se asigna a la variable filtro
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablamodernizacionllanos.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                     ...
                                     //muestra datos en tabla
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formulariomodernizacionllanos.jsp?ID=" + resul.getString("idMODERNIZACIONLLANOS") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formulariomodernizacionllanos.jsp?ID=" + resul.getString("idMODERNIZACIONLLANOS") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

...
public final class Tablariesgoelectrico_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    location.href = 'formulariocrearriesgoelectrico.jsp?ID=0&Accion=';\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("        </script> \n");
      out.write("    </head> \n");
...
if (rol == 1) {
      ...
      out.write("            <div class=\"container\">\n");
      out.write("                <h1 class=\"pull-left\">Tabla Riesgo Electrico</h1>\n");
      out.write("                <ul class=\"pull-right breadcrumb\">\n");
      out.write("                    <li><a href=\"index.jsp\">Inicio</a> <span class=\"divider\">/</span></li>\n");
      out.write("                    <li class=\"active\">Tabla Riesgo Electrico</li>\n");
      out.write("                </ul>\n");
      out.write("            </div><!--/container-->\n");
      ...
      out.write("                                    ");
                                        ...
                                        try {
                                            ...
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formularioriesgoelectrico.jsp?ID=" + resul.getString("idRIESGOELECTRICO") + "&Accion=Editar'>Editar</a></td>";
                                                html += "<td><a href='formularioriesgoelectrico.jsp?ID=" + resul.getString("idRIESGOELECTRICO") + "&Accion=Eliminar'>Eliminar</a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

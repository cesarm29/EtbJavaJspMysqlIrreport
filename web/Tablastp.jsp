<%-- 
    Document   : Tablastp
    Created on : 24/06/2014, 01:43:25 PM
    Author     : cesar1
--%>

<%@page import="java.sql.ResultSet"%>
<%@page import="DAO.StpDAO"%>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearstp.jsp?ID=0&Accion=';
                });
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de StpDAO
                            StpDAO obj2 = new StpDAO();
                            //se recibe el parametro q y se asigna a la variable filtro
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablastp.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                <strong>&nbsp;<%=total < 10 ? total+"" : "10"%> Registros :  <%=total%> Pagina: <%=pageNro%></strong>
                        </p>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formulariostp.jsp?ID=" + resul.getString("idSTP") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formulariostp.jsp?ID=" + resul.getString("idSTP") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

<%-- 
    Document   : formulariomodernizacionllanos
    Created on : 24/06/2014, 09:10:26 AM
    Author     : cesar1
--%>

<%@page import="DTO.ModernizacionLlanosDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de ModernizacionLLanosDTO
                ModernizacionLlanosDTO a = new ModernizacionLlanosDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instanciacion ModernizacionLlanosDAO
                    ModernizacionLlanosDAO d = new ModernizacionLlanosDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Renovacion Red Llanos Fase 1</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Renovacion Red Llanos Fase 1</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlModernizacionLlanos" method="post">
                            ...
                            <input type="number" name="idMODERNIZACIONLLANOS" value="<%= a.getIdMODERNIZACIONLLANOS()%>" id="idMODERNIZACIONLLANOS" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablamodernizacionllanos.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

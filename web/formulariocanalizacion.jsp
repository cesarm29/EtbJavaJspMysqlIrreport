<%-- 
    Document   : formulariocanalizacion
    Created on : 24/06/2014, 09:31:52 AM
    Author     : cesar1
--%>

<%@page import="DAO.CanalizacionDAO"%>
<%@page import="DTO.CanalizacionDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de CanalizacionDTO
                CanalizacionDTO a = new CanalizacionDTO();
                //se crea nos string's y van a ser igual a 2 parametros Accion y ID que se reciben por un request
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de CanalizacionDAO
                    CanalizacionDAO d = new CanalizacionDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Mantenimiento Canalizacion Regionales</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario Mantenimiento Canalizacion Regionales</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">       	
                    ...
                    <center><form class="reg-page" action="ControlCanalizacion" method="post">
                            ...
                            <input type="number" name="idCANALIZACION" value="<%= a.getIdCANALIZACION()%>" id="idCANALIZACION" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'TablaCanalizacion.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

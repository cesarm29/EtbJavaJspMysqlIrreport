<%-- 
    Document   : insertarcsvmantenimientocanalizacionbogota
    Created on : 28/08/2014, 10:12:38 AM
    Author     : cesar
--%>
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    if(count > 0){
                        ...
                        String sql ="insert into mantenimientocanalizacionbogota (idMANTENIMIENTOCANALIZACIONBOGOTA, central, distrito, pr, tema, costocontrato, costoproyecto, pares, estado, fechaentrega, inicioprogramado, finprogramado, avance, fechareporte, mesfacturacion, contratista, USUARIOS_idUSUARIOS) values(";

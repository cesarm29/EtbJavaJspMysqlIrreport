<%-- 
    Document   : insertarcsvredesinternasregionales
    Created on : 28/08/2014, 02:39:05 PM
    Author     : cesar
--%>
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    if(count > 0){
                        ...
                        String sql ="insert into redesinternasregionales (idREDESINTERNASREGIONALES, central, distrito, pr, tema, costocontrato, costoproyecto, pares, estado, fechaentrega, inicioprogramado, finprogramado, avance, fechareporte, mesfacturacion, contratista, USUARIOS_idUSUARIOS) values(";

<%-- 
    Document   : formulariocrearacometidaselectricas
    Created on : 5/08/2014, 10:46:07 AM
    Author     : cesar1
--%>
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlCrearAcometidasElectricas" method="post">

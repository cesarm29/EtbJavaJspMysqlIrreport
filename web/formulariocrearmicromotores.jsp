<%-- 
    Document   : formulariocrearmicromotores
    Created on : 11/08/2014, 10:05:51 AM
    Author     : cesar
--%>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de MicromotoresDAO
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlCrearMicromotores" method="post">

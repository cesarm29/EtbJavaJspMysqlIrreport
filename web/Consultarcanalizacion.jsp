<%-- 
    Document   : Consultarcanalizacion
    Created on : 2/07/2014, 02:23:12 PM
    Author     : cesar1
--%>
        ...
        <script type="text/javascript">
            <%
                ...
                if (id != null && !id.equals("")) {
                    ...
                    //se hace la consulta de contrado y se le hace un parseo a el id, verifica si es null o vacio
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Consulta Canalizacion</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Consulta Canalizacion</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">                    
                    ...
                    <center><header>Canalizacion</header></center>                         
                    <fieldset>
                    ...
                    <div style="width: 70%; margin: 0px auto;">         
                        <% if (contrado != null) {
                                ...
                                if (id != null)//ejecuta
                                {
                                    out.print("<center><div style=\"color: red\">La Canalizacion No Existe</div></center>");
                                }
                            }
                        %>
                    </div>

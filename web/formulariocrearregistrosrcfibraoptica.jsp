<%-- 
    Document   : formulariocrearregistrosrcfibraoptica
    Created on : 11/08/2014, 02:16:00 PM
    Author     : cesar
--%>
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlCrearRegistrosRcFibraOptica" method="post">

<%-- 
    Document   : formulariomicromotores
    Created on : 17/07/2014, 11:08:25 AM
    Author     : cesar1
--%>

<%@page import="DTO.MicromotoresDTO"%>
<%@page import="DAO.MicromotoresDAO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  
                ...
                String Title = "Crear";
                //se crea una nueva instancia de MicromotoresDTO
                MicromotoresDTO a = new MicromotoresDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instanciacion de MicromotoresDAO
                    MicromotoresDAO d = new MicromotoresDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Micromotores</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario Micromotores</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlMicromotores" method="post">
                           <div class="container-fluid">
                            ...
                            <input type="number" name="idMICROMOTORES" value="<%= a.getIdMICROMOTORES()%>" id="idMICROMOTORES" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablamicromotores.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

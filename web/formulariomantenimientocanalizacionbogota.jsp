<%-- 
    Document   : formulariomantenimientocanalizacionbogota
    Created on : 17/07/2014, 09:10:43 AM
    Author     : cesar1
--%>

<%@page import="DTO.MantenimientoCanalizacionBogotaDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de MantenimientoCanaliazcionBogotaDTO
                MantenimientoCanalizacionBogotaDTO a = new MantenimientoCanalizacionBogotaDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de MantenimientoCanalizacionBogotaDAO
                    MantenimientoCanalizacionBogotaDAO d = new MantenimientoCanalizacionBogotaDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Mantenimiento Canalizacion Bogota</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario Mantenimiento Canalizacion Bogota</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlMantenimientoCanalizacionBogota" method="post">
                            ...
                            <input type="number" name="idMANTENIMIENTOCANALIZACIONBOGOTA" value="<%= a.getIdMANTENIMIENTOCANALIZACIONBOGOTA()%>" id="idMANTENIMIENTOCANALIZACIONBOGOTA" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablamantenimientocanalizacionbogota.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

<%-- 
    Document   : insertarcsvproyectos
    Created on : 28/08/2014, 02:28:52 PM
    Author     : cesar
--%>
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    if(count > 0){
                        ...
                        String sql ="insert into proyectos (idPROYECTOS, central, distrito, pr, tema, costocontrato, costoproyecto, pares, estado, inicioprogramado, finprogramado, avance, fechareporte, mesfacturacion, contratista, USUARIOS_idUSUARIOS) values(";
                        sql += "'" + cels[0]+"','"+cels[1] + "','" + cels[2] + "','" +cels[3] + "','" +cels[4] + "','" +cels[5] + "','" +cels[6] + "','" +cels[7] + "','" +cels[8] + "','" +cels[9] + "','" +cels[10] + "','" +cels[11] + "','" +cels[12] + "','" +cels[13] + "','" +cels[14] + "','" +cels[15] + "');";

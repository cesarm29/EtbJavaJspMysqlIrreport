<%-- 
    Document   : formulariocrearriesgoelectrico
    Created on : 14/08/2014, 07:24:55 AM
    Author     : cesar
--%>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de RiesgoElectricoDAO
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlCrearRiesgoElectrico" method="post">

<%-- 
    ...
    Created on : 1/07/2014, 07:50:39 AM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <style>
            ...
            */
            ...
            (min-device-width: 768px) and (max-device-width: 1024px)  {
                ...
                Label the data
                */
                td:nth-of-type(1):before { content: "ID usuarios"; }
                td:nth-of-type(2):before { content: "usuario"; }
                td:nth-of-type(3):before { content: "contraseña"; }
                td:nth-of-type(4):before { content: "nombres"; }
                td:nth-of-type(5):before { content: "apellidos"; }
                td:nth-of-type(6):before { content: "estado"; }
                td:nth-of-type(7):before { content: "Editar"; }
                td:nth-of-type(8):before { content: "Eliminar"; }
                td:nth-of-type(9):before { content: "Conf."; }
            }
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'Regusuario.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Usuarios</h1>
        ...
        <div class="container">		
            <div class="row-fluid">
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        <input type="button" class="btn-u pull-rgt" id="btnNuevo" name="btnNuevo" value="Crear Nuevo Usuario" />
                        <br>
                        <br>
                        <div id="busqueda">
                            <form action="">
                                <right><input type="text" id="q" name="q" value="" placeholder="Busqueda por Nombres"/></right>
                                </br>
                        ...
                        <p>Paginas
                            ...
                            //se asignan los datos de un resultset pasandole los parametros filtro,pageNro
                            int total = obj2.getTotalRegistro(filtro != "");
                            int totalPag = (total / 10);
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="TablaUsuarios.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                        ...
                        <table style="width:900px">
                            <thead>
                                <tr>
                                    ...
                                    <th>Apellidos</th>
                                    <th>Estado</th>
                                    <th><center><IMG SRC="img/44.png" style="width:30px"></center></th>
                                    <th><center><IMG SRC="img/75.png" style="width:30px"></center></th>
                                    <th><center><IMG SRC="img/51.png" style="width:30px"></center></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>

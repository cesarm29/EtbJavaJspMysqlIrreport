<%-- 
    Document   : insertarcsvregistrosrcfibraoptica
    Created on : 28/08/2014, 03:12:33 PM
    Author     : cesar
--%>
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    if(count > 0){
                        ...
                        String sql ="insert into registrosrcfibraoptica (idREGISTROSRCFIBRAOPTICA, central, distrito, pr, tema, costocontrato, costoproyecto, pares, estado, fechaentrega, inicioprogramado, finprogramado, avance, fechareporte, mesfacturacion, contratista, USUARIOS_idUSUARIOS) values(";

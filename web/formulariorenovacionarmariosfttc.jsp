<%-- 
    Document   : formulariorenovacionarmariosfttc
    Created on : 21/07/2014, 10:51:16 AM
    Author     : cesar1
--%>

<%@page import="DTO.RenovacionArmariosFttcDTO"%>
<%@page import="DAO.RenovacionArmariosFttcDAO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de RenovacionArmariosFttDTO
                RenovacionArmariosFttcDTO a = new RenovacionArmariosFttcDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de RenovacionArmariosFttcDAO
                    RenovacionArmariosFttcDAO d = new RenovacionArmariosFttcDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Renovacion Armarios Fttc</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Renovacion Armarios Fttc</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlRenovacionArmariosFttc" method="post">
                            ...
                            <input type="number" name="idRENOVACIONARMARIOSFTTC" value="<%= a.getIdRENOVACIONARMARIOSFTTC()%>" id="idRENOVACIONARMARIOSFTTC" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablarenovacionarmariosfttc.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

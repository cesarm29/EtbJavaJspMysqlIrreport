<%-- 
    Document   : Tablarenovacionarmariosfttc
    Created on : 21/07/2014, 10:49:38 AM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearrenovacionarmariosfttc.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Renovacion Armarios Fttc</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Renovacion Armarios Fttc</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
        ...
        <div class="container">		
			...
			<right><input type="text" id="q" name="q" value="" placeholder="Busqueda por pr"/></right>
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de RenovacionArmariosFttcDAO
                            RenovacionArmariosFttcDAO obj2 = new RenovacionArmariosFttcDAO();
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablarenovacionarmariosfttc.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formulariorenovacionarmariosfttc.jsp?ID=" + resul.getString("idRENOVACIONARMARIOSFTTC") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formulariorenovacionarmariosfttc.jsp?ID=" + resul.getString("idRENOVACIONARMARIOSFTTC") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

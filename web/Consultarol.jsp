<%-- 
    ...
    Created on : 2/07/2014, 01:20:15 PM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
    <head>
        ...
        <script type="text/javascript">
            <%
                //RolesDTO se le da el valor de null
                RolesDTO contrado = null;
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Consulta Rol</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Consulta Rol</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">                    
                    ...
                    <center><header>Roles</header></center>                         
                    <fieldset>
                        <center><label class="input"> 
                            <input type="number" name="numero_identidad" id="numero_identidad" value="<%=id%>"/>
                            <label for="numero_identidad">Ingrese la Identificacion del Rol</label>
                            </label></center>
                    </fieldset>
                    <div style="width: 70%; margin: 0px auto;">         
                        <% if (contrado != null) {
                                ...
                                out.print("<br>");
                                out.print("<h3>Nombre: " + contrado.getNombre() + "</h3>");
                                out.print("<h3>Descripcion: " + contrado.getDescripcion() + "</h3>");
                            } else {
                                if (id != null)//ejecuta
                                {
                                    out.print("<center><div style=\"color: red\">El Rol No Existe</div></center>");
                                }
                            }
                        %>
                    </div>

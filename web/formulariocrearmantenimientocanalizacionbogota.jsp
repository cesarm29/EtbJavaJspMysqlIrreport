<%-- 
    Document   : formulariocrearmantenimientocanalizacionbogota
    Created on : 11/08/2014, 09:04:14 AM
    Author     : cesar
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de MantenimientoCanalizacionBogotaDTO
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlCrearMantenimientoCanalizacionBogota" method="post">

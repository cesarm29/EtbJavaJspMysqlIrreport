<%-- 
    Document   : Tablaregistrosrcfibraoptica
    Created on : 21/07/2014, 09:48:29 AM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearregistrosrcfibraoptica.jsp?ID=0&Accion=';
                });
            });
        </script> 
    </head> 
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Registros Rc Fibra Optica</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Registros Rc Fibra Optica</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
        ...
        <div class="container">		
			...
			<right><input type="text" id="q" name="q" value="" placeholder="Busqueda por pr"/></right>
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de RegistrosRcFibraOpticaDAO
                            RegistrosRcFibraOpticaDAO obj2 = new RegistrosRcFibraOpticaDAO();
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablaregistrosrcfibraoptica.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formularioregistrosrcfibraoptica.jsp?ID=" + resul.getString("idREGISTROSRCFIBRAOPTICA") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formularioregistrosrcfibraoptica.jsp?ID=" + resul.getString("idREGISTROSRCFIBRAOPTICA") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

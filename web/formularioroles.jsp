<%-- 
    Document   : formularioroles
    Created on : 25/06/2014, 03:02:18 PM
    Author     : cesar1
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de RolesDTO
                RolesDTO a = new RolesDTO();
                //se crean dos strings y van a ser igual a 2 parametros Accion y ID que se reciben por un request
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Roles</h1>
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">                    
                    ...
                    <center><form class="reg-page" action="RolesCtrol" method="post">
                            ...
                            <input type="number" name="idROLES" value="<%= a.getIdRoles()%>" id="idROLES" /> 
                            <label>Nombre :</label>
                            <input title="Se necesita el nombre del rol" type="text" value="<%= a.getNombre()%>" name="nombre" id="nombre" required/> 
                            <br/>
                            </div>
                            <div class="span3">
                            <label>Descripcion:</label>
                            <input title="Se necesita el nombre de la descripcion" type="text" name="descripcion" id="descripcion" value="<%= a.getDescripcion()%>" required /> 
                            <br/>
                            </div> 
                            <div class="span12">
                            <input type="submit" class="btn-u pull-rgt" name="btnSubmit" id="btnSubmit" value="<%=Title%>"/>
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaroles.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

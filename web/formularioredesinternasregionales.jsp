<%-- 
    Document   : formularioredesinternasregionales
    Created on : 18/07/2014, 08:34:51 AM
    Author     : cesar1
--%>

<%@page import="DAO.RedesInternasRegionalesDAO"%>
<%@page import="DTO.RedesInternasRegionalesDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de RedesInternasRegionalesDTO
                RedesInternasRegionalesDTO a = new RedesInternasRegionalesDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de RedesInternasRegionalesDAO
                    RedesInternasRegionalesDAO d = new RedesInternasRegionalesDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Redes Internas Regionales</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario Redes Internas Regionales</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlRedesInternasRegionales" method="post">
                            ...
                            <input type="number" name="idREDESINTERNASREGIONALES" value="<%= a.getIdREDESINTERNASREGIONALES()%>" id="idREDESINTERNASREGIONALES" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaredesinternasregionales.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

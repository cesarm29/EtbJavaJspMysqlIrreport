<%-- 
    Document   : page500
    Created on : 26/06/2014, 10:15:01 AM
    Author     : cesar1
--%>
    ...
    <body>
        ...
        <div class="header">               
            <div class="container"> 
                <!-- Logo -->       
                <div class="logo">                                             
                    <a href="index.html"><img id="logo-header" src="assets/img/logo_etb.png" alt="Logo"></a>
                </div><!-- /logo -->                                         
                <!-- Menu -->       
                <div class="navbar">                                
        ...
        <div class="breadcrumbs margin-bottom-40">
            <div class="container">
                <h1 class="color-green pull-left">Pagina No Encontrada</h1>
        ...
        <div class="container">	
            ...
            <div class="row-fluid page-404">
                <p><span>ERROR</span><i>500</i> <span>El servidor no se encuentra disponible</span></p>

<%-- 
    Document   : formularioregionalesbase
    Created on : 16/07/2014, 11:30:40 AM
    Author     : cesar1
--%>

<%@page import="DAO.RegionalesBaseDAO"%>
<%@page import="DTO.RegionalesBaseDTO"%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna a un titulo
                String Title = "Crear";
                //se crea una nueva instancia de RegionalesBaseDTO
                RegionalesBaseDTO a = new RegionalesBaseDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de RegionalesBaseDAO
                    RegionalesBaseDAO d = new RegionalesBaseDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario de Regionales Base</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario de Regionales Base</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlRegionalesBase" method="post">
                           <div class="container-fluid">
                            ...
                            <input type="number" name="idREGIONALESBASE" value="<%= a.getIdREGIONALESBASE()%>" id="idREGIONALESBASE" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaregionalesbase.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

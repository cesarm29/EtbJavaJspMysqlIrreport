<%-- 
    Document   : formularioriesgoelectrico
    Created on : 21/07/2014, 08:20:59 AM
    Author     : cesar1
--%>

<%@page import="DTO.RiesgoElectricoDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de RiesgoElectricoDTO
                RiesgoElectricoDTO a = new RiesgoElectricoDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    RiesgoElectricoDAO d = new RiesgoElectricoDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Riesgo Electrico</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Riesgo Electrico</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlRiesgoElectrico" method="post">
                            ...
                            <input type="number" name="idRIESGOELECTRICO" value="<%= a.getIdRIESGOELECTRICO()%>" id="idRIESGOELECTRICO" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablariesgoelectrico.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

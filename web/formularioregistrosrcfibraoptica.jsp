<%-- 
    Document   : formularioregistrosrcfibraoptica
    Created on : 21/07/2014, 09:49:10 AM
    Author     : cesar1
--%>

<%@page import="DTO.RegistrosRcFibraOpticaDTO"%>
<%@page import="DAO.RegistrosRcFibraOpticaDAO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de RegistrosRcFibraOpticaDTO
                RegistrosRcFibraOpticaDTO a = new RegistrosRcFibraOpticaDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instancia de RegistrosRcFibraOpticaDAO
                    RegistrosRcFibraOpticaDAO d = new RegistrosRcFibraOpticaDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Registros Rc Fibra Optica</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Registros Rc Fibra Optica</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlRegistrosRcFibraOptica" method="post">
                            ...
                            <input type="number" name="idREGISTROSRCFIBRAOPTICA" value="<%= a.getIdREGISTROSRCFIBRAOPTICA()%>" id="idREGISTROSRCFIBRAOPTICA" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaregistrosrcfibraoptica.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

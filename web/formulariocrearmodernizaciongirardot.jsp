<%-- 
    Document   : formulariocrearmodernizaciongirardot
    Created on : 11/08/2014, 10:30:02 AM
    Author     : cesar
--%>

<%@page import="DAO.ModernizacionGirardotDAO"%>
<%@page import="DTO.ModernizacionGirardotDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%      //se crea string y se le asigna un titulo
                    String Title = "Crear";
                    //se crea una nueva instancia de ModernizacionGirardotDTO
                    ModernizacionGirardotDTO a = new ModernizacionGirardotDTO();
                    //se crean dos string's y van a ser igual a 2 parametros Accion y ID que se reciben por un request
                    String accion = request.getParameter("Accion");
                    String id = request.getParameter("ID");
                    //evalua si la accion es igual a Eliminar o Editar o Vacio, si es igual a Editar les asign a a la variable
                    ...
                    if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                        ...
                        //nueva instancia de ModernizacionGirardotDAO
                        ModernizacionGirardotDAO d = new ModernizacionGirardotDAO();
                        try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Renovacion Red Girardot</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario Renovacion Red Girardot</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlCrearModernizacionGirardot" method="post">
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablamodernizaciongirardot.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

<%-- 
    Document   : formulariodemolicionbase
    Created on : 24/06/2014, 09:22:54 AM
    Author     : cesar1
--%>

<%@page import="DTO.DemolicionBaseDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de DemolicionBaseDTO
                DemolicionBaseDTO a = new DemolicionBaseDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    DemolicionBaseDAO d = new DemolicionBaseDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario Demolicion Base</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>               
                        <li class="active"> Formulario Demolicion Base</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">       	
                    ...
                    <center><form class="reg-page" action="ControlDemolicionBase" method="post">
                            ...
                            <input type="number" name="idDEMOLICIONBASE" value="<%= a.getIdDEMOLICIONBASE()%>" id="idDEMOLICIONBASE" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablademolicionbase.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

<%-- 
    Document   : formulariomodernizaciongirardot
    Created on : 24/06/2014, 09:17:14 AM
    Author     : cesar1
--%>
        ...
        <div class="body">
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlModernizacionGirardot" method="post">
                            ...
                            <input type="number" name="idMODERNIZACIONGIRARDOT" value="<%= a.getIdMODERNIZACIONGIRARDOT()%>" id="idMODERNIZACIONGIRARDOT" /> 
                            <label>Central :</label>

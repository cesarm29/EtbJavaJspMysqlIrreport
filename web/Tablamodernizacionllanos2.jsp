<%-- 
    Document   : Tablamodernizacionllanos2
    Created on : 15/07/2014, 10:10:55 AM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#btnNuevo").click(function() {
                    location.href = 'formulariocrearmodernizacionllanos2.jsp?ID=0&Accion=';
                });
    ...
    <body>
        ...
        <div class="row-fluid breadcrumbs margin-bottom-20">
            <div class="container">
                <h1 class="pull-left">Tabla Renovacion Red Llanos Fase 2</h1>
                <ul class="pull-right breadcrumb">
                    <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                    <li class="active">Tabla Renovacion Red Llanos Fase 2</li>
                </ul>
            </div><!--/container-->
        </div><!--/breadcrumbs-->
        <!--=== End Breadcrumbs ===-->
                ...
                <div class="row-fluid margin-bottom-20">
                    <div class="span6">
                        ...
                        <p>Paginas
                            ...
                            //nueva instanciacion de ModernizacionLlanos2DAO
                            ModernizacionLlanos2DAO obj2 = new ModernizacionLlanos2DAO();
                            ...
                            for(int x = 1; x <= totalPag ; x++){
                                %>
                                <a href="Tablamodernizacionllanos2.jsp?page=<%=x%>"><b><%=x%></b></a>&nbsp;&nbsp;&nbsp;
                           <% }
                            %>
                                    ...
                                    <%
                                        ...
                                        try {
                                            while (resul.next()) {
                                                ...
                                                html += "<td><a href='formulariomodernizacionllanos2.jsp?ID=" + resul.getString("idMODERNIZACIONLLANOS2") + "&Accion=Editar'><center>Editar</center></a></td>";
                                                html += "<td><a href='formulariomodernizacionllanos2.jsp?ID=" + resul.getString("idMODERNIZACIONLLANOS2") + "&Accion=Eliminar'><center>Eliminar</center></a></td>";
                                                html += "</tr>";
                                                out.print(html);
                                            }
                                        } catch (Exception ex) {

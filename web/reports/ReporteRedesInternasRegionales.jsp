<%-- 
    Document   : ReporteRedesInternasRegionales
    Created on : 28/07/2014, 10:02:25 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Redes Internas Regionales</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report18.jasper"));

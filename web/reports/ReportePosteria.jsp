<%-- 
    Document   : ReportePosteria
    Created on : 28/07/2014, 08:45:53 AM
    Author     : cesar1
--%>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report16.jasper"));

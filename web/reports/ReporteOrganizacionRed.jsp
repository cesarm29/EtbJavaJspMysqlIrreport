<%-- 
    Document   : ReporteOrganizacionRed
    Created on : 25/07/2014, 03:31:55 PM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Organizacion Red</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report14.jasper"));

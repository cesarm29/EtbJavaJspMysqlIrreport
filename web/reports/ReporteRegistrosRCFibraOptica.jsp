<%-- 
    Document   : ReporteRegistrosRCFibraOptica
    Created on : 29/07/2014, 09:11:52 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Registros Rc Fibra Optica</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report21.jasper"));

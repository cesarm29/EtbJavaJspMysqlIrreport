<%-- 
    Document   : ReporteConstruccionBase
    Created on : 10/07/2014, 10:21:02 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Construccion Base</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report7.jasper"));

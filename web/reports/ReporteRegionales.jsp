<%-- 
    Document   : ReporteRegionales
    Created on : 28/07/2014, 10:41:57 AM
    Author     : cesar1
--%>
...
<html>
    <head>
        ...
        <title>Reporte Regionales</title>
    ...
    <body>
        <%
            ...
            try{
                ...
                File reportFile = new File(application.getRealPath("//reports//report19.jasper"));

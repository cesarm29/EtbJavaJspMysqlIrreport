<%-- 
    Document   : formulariorganizacionredfttc
    Created on : 15/07/2014, 03:27:29 PM
    Author     : cesar1
--%>

<%@page import="DAO.OrganizacionRedFttcDAO"%>
<%@page import="DTO.OrganizacionRedFttcDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de OrganizacionRedFttcDTO
                OrganizacionRedFttcDTO a = new OrganizacionRedFttcDTO();
                ...
                if ((accion.equals("Eliminar") || accion.equals("Editar")) && !(id.equals(""))) {
                    ...
                    //nueva instanciacion OrganizacionRedFttcDAO
                    OrganizacionRedFttcDAO d = new OrganizacionRedFttcDAO();
                    try {
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario de Organizacion Red Fttc</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>                
                        <li class="active"> Formulario de Organizacion Red Fttc</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">        	
                    ...
                    <center><form class="reg-page" action="ControlOrganizacionRedFttc" method="post">
                            ...
                            <input type="number" name="idORGANIZACIONREDFTTC" value="<%= a.getIdORGANIZACIONREDFTTC()%>" id="idORGANIZACIONREDFTTC" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablaorganizacionredfttc.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

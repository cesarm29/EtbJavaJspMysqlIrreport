<%-- 
    Document   : dormulariostp
    Created on : 24/06/2014, 08:43:30 AM
    Author     : cesar1
--%>
<%@page import="DAO.StpDAO"%>
<%@page import="java.util.ArrayList"%>
<%@page import="DTO.StpDTO"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            <%  //se crea string y se le asigna un titulo
                String Title = "Crear";
                //se crea una nueva instancia de StpDTO
                StpDTO a = new StpDTO();
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Formulario SPT</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Formulario SPT</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            ...
            <div class="container">		
                <div class="row-fluid margin-bottom-10">
                    ...
                    <center><form class="reg-page" action="ControlStp" method="post">
                            ...
                            <input type="number" name="idSTP" value="<%= a.getIdSTP()%>" id="idSTP" /> 
                            <label>Central :</label>
                            ...
                            <input type="button" class="btn-u pull-lft" onclick="location.href = 'Tablastp.jsp'" name="btnSalir" id="btnSalir" value="Salir" /> 
                            </div>
                            </div>
                            </div>
                            </div>

<%-- 
    Document   : Consultaredesinternasregionales
    Created on : 21/07/2014, 01:13:08 PM
    Author     : cesar1
--%>
...
<!--[if !IE]><!--> <html lang="es"> <!--<![endif]-->  
    <head>
        ...
        <script type="text/javascript">
            <%
                //RedesInternasRegionalesDTO se le da el valor de null
                RedesInternasRegionalesDTO contrado = null;
                ...
                if (id != null && !id.equals("")) {
                    //nueva instanciacion de RedesInternasRegionalesDAO
    ...
    <body>
        ...
        <div class="body">
            <div class="breadcrumbs margin-bottom-50">
                <div class="container">
                    <h1 class="color-green pull-left">Consulta Redes Internas Regionales</h1>
                    <ul class="pull-right breadcrumb">
                        <li><a href="index.jsp">Inicio</a> <span class="divider">/</span></li>
                        <li class="active"> Consulta Redes Internas Regionales</li>
                    </ul>
                </div><!--/container-->
            </div><!--/breadcrumbs-->
            <div class="container">		
                <div class="row-fluid margin-bottom-10">                    
                    ...
                    <center><header>Redes Internas Regionales</header></center>                         
                    <fieldset>
                    ...
                    <div style="width: 70%; margin: 0px auto;">         
                        <% if (contrado != null) {
                                ...
                                if (id != null)//ejecuta
                                {
                                    out.print("<center><div style=\"color: red\">La Red Interna Regional No Existe</div></center>");
                                }
                            }
                        %>
                    </div>
